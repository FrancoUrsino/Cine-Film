...
import ConfirmUserInformationForm from '../cartConfirm/ConfirmUserInformationForm';
import ConfirmPayForm from '../cartConfirm/ConfirmPayForm';

function ConfirmIdPurchase() {
  ...
  return (
    <div className="p-8 py-20 grid grid-cols-1 lg:grid-cols-2 lg:w-10/12 mx-auto">
      <div className="max-w-lg w-full mx-auto lg:h-[430px] bg-third-color shadow-md lg:order-last text-center lg:text-start lg:rounded-lg">
...
export default ConfirmIdPurchase;
